...
ALTER TABLE reserva_idreserva_seq OWNER TO postgres;
...
--
-- Name: idreserva; Type: DEFAULT; Schema: public; Owner: postgres
--
...
COPY disponibles (iddisponibles, idorigen, iddestino, idtarifa, fechahora) FROM stdin;
1	10	15	1	2014-08-12 00:00:00
2	10	16	2	2014-08-13 00:00:00
3	20	15	3	2014-09-12 00:00:00
4	16	17	1	2014-08-12 00:00:00
5	17	20	2	2014-09-12 00:00:00
6	20	10	3	2014-08-13 00:00:00
\.
...
COPY hospedaje (idhospedaje, idsuite, idhotel, idreserva, dias) FROM stdin;
\.
...
COPY pago (idpago, idreserva, idcliente, monto, cupon, total) FROM stdin;
\.
...
COPY vuelo (idvuelo, idasiento, idreserva, idavion, idorigen, iddestino, idtarifa, fechahora) FROM stdin;
\.
...
ALTER TABLE ONLY disponibles
    ADD CONSTRAINT disponiblespk PRIMARY KEY (iddisponibles, idorigen, iddestino, idtarifa);
...
ALTER TABLE ONLY hospedaje
    ADD CONSTRAINT hospedajepk PRIMARY KEY (idhospedaje, idsuite, idhotel, idreserva, dias);
...
--
-- Name: pagopk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY pago
    ADD CONSTRAINT pagopk PRIMARY KEY (idpago);
...
--
-- Name: reservapk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY reserva
    ADD CONSTRAINT reservapk PRIMARY KEY (idreserva);
...
ALTER TABLE ONLY vuelo
    ADD CONSTRAINT vuelopk PRIMARY KEY (idvuelo, idasiento, idreserva, idavion, idorigen, iddestino);
...
ALTER TABLE ONLY hospedaje
    ADD CONSTRAINT hospedajefk3 FOREIGN KEY (idreserva) REFERENCES reserva(idreserva);


--
-- Name: pagofk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY pago
    ADD CONSTRAINT pagofk FOREIGN KEY (idreserva) REFERENCES reserva(idreserva);


--
-- Name: pagofk2; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY pago
    ADD CONSTRAINT pagofk2 FOREIGN KEY (idcliente) REFERENCES cliente(idcliente);
...
ALTER TABLE ONLY vuelo
    ADD CONSTRAINT vuelofk FOREIGN KEY (idorigen) REFERENCES aeropuerto(idaeropuerto);


--
-- Name: vuelofk2; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY vuelo
    ADD CONSTRAINT vuelofk2 FOREIGN KEY (iddestino) REFERENCES aeropuerto(idaeropuerto);


--
-- Name: vuelofk3; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY vuelo
    ADD CONSTRAINT vuelofk3 FOREIGN KEY (idtarifa) REFERENCES tarifa(idtarifa);
...
ALTER TABLE ONLY vuelo
    ADD CONSTRAINT vuelofk5 FOREIGN KEY (idreserva) REFERENCES reserva(idreserva);


--
-- Name: vuelofk6; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY vuelo
    ADD CONSTRAINT vuelofk6 FOREIGN KEY (idavion) REFERENCES avion(idavion);
